...
exports.init = function(cli) {
  ...
  cli.command("login").description($("Log in to an Azure subscription using Active Directory or a Microsoft account identity.")).option("-u --username <username>", $(("user name or service principal ID. If multifactor authentication is" + " required, you will be prompted to use the login command without parameters for interactive support."))).option("-e --environment [environment]", $("Environment to authenticate against, such as AzureChinaCloud; must support Active Directory.")).option("-p --password <password>", $("user password or service principal secret, will prompt if not given.")).option("--service-principal", $("If given, log in as a service principal rather than a user.")).option("--certificate-file <certificateFile>", $("A PEM encoded certificate private key file.")).option("--thumbprint <thumbprint>", $("A hex encoded thumbprint of the certificate.")).option("--tenant <tenant>", $("Tenant domain or ID to log into.")).option("-q --quiet", $("do not prompt for confirmation of PII storage.")).execute(function __1(options, _) { var piiWarningText, interactive, environmentName, environment, tenant, haveSeenBefore, password, requirePassword, progress, loginType, result, authObject, account, newSubscriptions, defaultSubscription, duped; var __frame = { name: "__1", line: 49 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
      ...
      tenant = options.tenant; return (function __$__1(__then) {
        if (options.servicePrincipal) {
          ...
          requirePassword = ((!options.servicePrincipal || !options.certificateFile)); return (function __$__1(__then) {
            if (((!interactive && requirePassword) && !options.password)) {
              return cli.interaction.promptPasswordOnceIfNotGiven("Password: ", options.password, __cb(_, __frame, 38, 35, function ___(__0, __4) { password = __4; __then(); }, true)); } else { __then(); } ; })(function __$__1() {
            ...
            progress = cli.interaction.progress($("Authenticating...")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function __$__1(__then) {
                          ...
                          if (!interactive) {
                            return adalAuth.removeCachedToken(options.username, __cb(_, __frame, 54, 19, __then, true)); } else { __then(); } ; })(function __$__1() {
                          ...
                          account = new Account(environment, authObject, resourceClient, log); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                                ...
                                return account.load(options.username, password, tenant, loginType, __cb(_, __frame, 64, 27, function ___(__0, __5) { result = __5; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$__1() { if (ex) {
  ...
  cli.command("logout [username]").description($("Log out from Azure subscription using Active Directory. Currently, the user can log out only via Microsoft organizational account")).option("-u --username <username>", $("Required. User name used to log out from Azure Active Directory.")).execute(function __2(username, options, _) { var __frame = { name: "__2", line: 159 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
