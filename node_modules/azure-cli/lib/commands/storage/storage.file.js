...
exports.init = function(cli) {
  ...
  function createShare(share, options, _) { var fileService, operation, tips, storageOptions, created; var __frame = { name: "createShare", line: 334 }; return __func(_, this, arguments, createShare, 2, __frame, function __$createShare() {
  ...
  function deleteShare(share, options, _) { var fileService, operation, tips, storageOptions, force; var __frame = { name: "deleteShare", line: 361 }; return __func(_, this, arguments, deleteShare, 2, __frame, function __$deleteShare() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function showShare(share, options, _) { var fileService, operation, tips, storageOptions, properties, getStatsOperation, stats; var __frame = { name: "showShare", line: 396 }; return __func(_, this, arguments, showShare, 2, __frame, function __$showShare() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function setShare(share, options, _) { var fileService, tips, properties, getPropertiesOperation, storageOptions, setPropertiesOperation; var __frame = { name: "setShare", line: 427 }; return __func(_, this, arguments, setShare, 2, __frame, function __$setShare() {
      fileService = getFileServiceClient(options);
  ...
  function listShares(prefix, options, _) { var fileService, listOperation, tips, storageOptions, shares; var __frame = { name: "listShares", line: 462 }; return __func(_, this, arguments, listShares, 2, __frame, function __$listShares() {
      fileService = getFileServiceClient(options);
  ...
  function createShareSas(share, permissions, expiry, options, _) { var __frame = { name: "createShareSas", line: 494 }; return __func(_, this, arguments, createShareSas, 4, __frame, function __$createShareSas() {
  ...
  function createFileSas(share, path, permissions, expiry, options, _) { var __frame = { name: "createFileSas", line: 501 }; return __func(_, this, arguments, createFileSas, 5, __frame, function __$createFileSas() {
  ...
  function createSas(share, path, permissions, protocol, ipRange, expiry, options, isShare, _) { var fileService, accessType, start, output, sharedAccessPolicy, tips, result, directory, file; var __frame = { name: "createSas", line: 508 }; return __func(_, this, arguments, createSas, 8, __frame, function __$createSas() {
      fileService = getFileServiceClient(options);
  ...
  function createSharePolicy(share, name, options, _) { var createPolicySettings, policies; var __frame = { name: "createSharePolicy", line: 568 }; return __func(_, this, arguments, createSharePolicy, 3, __frame, function __$createSharePolicy() {
  ...
  function listSharePolicy(share, options, _) { var listPolicySettings, policies; var __frame = { name: "listSharePolicy", line: 588 }; return __func(_, this, arguments, listSharePolicy, 2, __frame, function __$listSharePolicy() {
  ...
  function showSharePolicy(share, name, options, _) { var showPolicySettings, policy; var __frame = { name: "showSharePolicy", line: 606 }; return __func(_, this, arguments, showSharePolicy, 3, __frame, function __$showSharePolicy() {
  ...
  function setSharePolicy(share, name, options, _) { var setPolicySettings, policies; var __frame = { name: "setSharePolicy", line: 621 }; return __func(_, this, arguments, setSharePolicy, 3, __frame, function __$setSharePolicy() {
  ...
  function deleteSharePolicy(share, name, options, _) { var deletePolicySettings, policies; var __frame = { name: "deleteSharePolicy", line: 641 }; return __func(_, this, arguments, deleteSharePolicy, 3, __frame, function __$deleteSharePolicy() {
  ...
  function listFiles(share, path, options, _) { var fileService, listOperation, tips, storageOptions, listResults, setUriFunc; var __frame = { name: "listFiles", line: 665 }; return __func(_, this, arguments, listFiles, 3, __frame, function __$listFiles() {
      fileService = getFileServiceClient(options);
  ...
  function deleteFile(share, path, options, _) { var fileService, operation, tips, storageOptions, force, result, directory, file; var __frame = { name: "deleteFile", line: 714 }; return __func(_, this, arguments, deleteFile, 3, __frame, function __$deleteFile() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function uploadFile(source, share, path, options, _) { var fileService, storageOptions, force, fsStatus, pathIsDirectory, remoteFileExists, directory, file, result, summary, printer, intervalId, succeeded, uploadFileResult; var __frame = { name: "uploadFile", line: 755 }; return __func(_, this, arguments, uploadFile, 4, __frame, function __$uploadFile() {
      fileService = getFileServiceClient(options);
                        ...
                        if (path) {
                          ...
                          file = result.basename; return (function __$uploadFile(_) {
                            ...
                            return performStorageOperation(getStorageFileOperation(fileService, "doesFileExist"), __cb(_, __frame, 42, 10, function ___(__0, __3) {
                              ...
                              var __2 = __3.exists; return _(null, __2); }, true), share, directory, file, storageOptions); })(__cb(_, __frame, -754, 18, function ___(__0, __9) { return (function __$uploadFile(__then) { if (__9) {
                                ...
                                remoteFileExists = true; __then(); } else { return (function __$uploadFile(_) {
                                  ...
                                  var __2 = pathIsDirectory; if (__2) { return _(null, __2); } ; return performStorageOperation(getStorageFileOperation(fileService, "doesDirectoryExist"), __cb(_, __frame, 54, 36, function ___(__0, __4) {
                                    ...
                                    var __3 = __4.exists; return _(null, __3); }, true), share, path); })(__cb(_, __frame, -754, 18, function ___(__0, __10) { return (function __$uploadFile(__then) { if (__10) {
                          ...
                          var __3 = remoteFileExists; if (__3) { return _(null, __3); } ; return performStorageOperation(getStorageFileOperation(fileService, "doesFileExist"), __cb(_, __frame, 87, 30, function ___(__0, __5) {
                            ...
                            var __4 = __5.exists; return _(null, __4); }, true), share, directory, file, storageOptions); })(__cb(_, __frame, -754, 18, function ___(__0, __13) { return (function __$uploadFile(__then) { if (__13) {
  ...
  function downloadFile(share, path, destination, options, _) { var fileService, storageOptions, force, result, directory, file, stat, operation, summary, printer, intervalId, downloadedFile; var __frame = { name: "downloadFile", line: 902 }; return __func(_, this, arguments, downloadFile, 4, __frame, function __$downloadFile() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function getStorageFileProperties(share, path, options, _) { var fileService, storageOptions, file, result, propertiesOperation, tips; var __frame = { name: "getStorageFileProperties", line: 984 }; return __func(_, this, arguments, getStorageFileProperties, 3, __frame, function __$getStorageFileProperties() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function doesStorageFileExist(share, path, options, _) { var fileService, storageOptions, propertiesOperation, result; var __frame = { name: "doesStorageFileExist", line: 1011 }; return __func(_, this, arguments, doesStorageFileExist, 3, __frame, function __$doesStorageFileExist() {
      fileService = getFileServiceClient(options);
      storageOptions = getStorageFileOperationDefaultOption();
  ...
  function createDirectory(share, path, options, _) { var fileService, operation, tips, storageOptions, directoryResult; var __frame = { name: "createDirectory", line: 1022 }; return __func(_, this, arguments, createDirectory, 3, __frame, function __$createDirectory() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
  ...
  function deleteDirectory(share, path, options, _) { var fileService, operation, tips, storageOptions, force; var __frame = { name: "deleteDirectory", line: 1044 }; return __func(_, this, arguments, deleteDirectory, 3, __frame, function __$deleteDirectory() {
      fileService = getFileServiceClient(options);
      return interaction.promptIfNotGiven($("Share name: "), share, __cb(_, __frame, 2, 24, function ___(__0, __1) { share = __1;
        return interaction.promptIfNotGiven($("Path to the directory to be created: "), path, __cb(_, __frame, 3, 23, function ___(__0, __2) { path = __2;
  ...
  function startFileCopy(sourceUri, destShare, options, _) { var startCopyParams; var __frame = { name: "startFileCopy", line: 1085 }; return __func(_, this, arguments, startFileCopy, 3, __frame, function __$startFileCopy() {
  ...
  function showFileCopy(share, path, options, _) { var showCopyParams; var __frame = { name: "showFileCopy", line: 1095 }; return __func(_, this, arguments, showFileCopy, 3, __frame, function __$showFileCopy() {
      showCopyParams = {
  ...
  function stopFileCopy(share, path, copyid, options, _) { var getStopOperation, stopCopyParams; var __frame = { name: "stopFileCopy", line: 1107 }; return __func(_, this, arguments, stopFileCopy, 4, __frame, function __$stopFileCopy() {
