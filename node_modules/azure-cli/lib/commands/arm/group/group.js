...
exports.init = function(cli) {
  ...
  group.command("set [name]").description($("Set tags to a resource group")).usage("[options] <name> <tags>").option("-n --name <name>", $("the resource group name")).option("-t --tags <tags>", $(("Tags to set to the resource group. Can be multiple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("--no-tags", $("remove all existing tags")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __2(name, options, _) { var updatedGroup; var __frame = { name: "__2", line: 67 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
  ...
  group.createResourceGroup = function group_createResourceGroup__3(name, location, options, _) { var subscription, client, existingGroup, message, doneMessage, tags, group; var __frame = { name: "group_createResourceGroup__3", line: 72 }; return __func(_, this, arguments, group_createResourceGroup__3, 3, __frame, function __$group_createResourceGroup__3() {
      subscription = profile.current.getSubscription(options.subscription);
      client = utils.createResourceClient(subscription);



      return cli.interaction.withProgress(util.format($("Getting resource group %s"), name), function __1(log, _) { var __frame = { name: "__1", line: 79 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
        ...
        return cli.interaction.withProgress(message, function __2(log, _) { var __frame = { name: "__2", line: 105 }; return __func(_, this, arguments, __2, 1, __frame, function __$__2() { return (function __$__2(__then) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete resource group %s? [y/n] "), name), __cb(_, __frame, 1, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -135, 17, function ___(__0, __2) { return (function __$__4(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__4() {
          ...
          progress = cli.interaction.progress(util.format($("Deleting resource group %s"), name)); return (function __$__4(__then) {
            if (options.nowait) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {
                    ...
                    return client.resourceGroups.beginDeleteMethod(name, __cb(_, __frame, 10, 32, function __$__4() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__4() {
                    ...
                    return client.resourceGroups.deleteMethod(name, __cb(_, __frame, 16, 32, function __$__4() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__4() {
  ...
  group.command("show [name]").description($("Shows a resource group for your subscription")).usage("[options] <name>").option("-n --name <name>", $("the resource group name")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __6(name, options, _) { var subscription, client, authzClient, progress, resourceGroup; var __frame = { name: "__6", line: 243 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      progress = cli.interaction.progress($("Listing resource groups")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
            ...
            return client.resourceGroups.get(name, __cb(_, __frame, 8, 46, function ___(__0, __1) { resourceGroup = __1; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
          ...
          progress = cli.interaction.progress($("Listing resources for the group")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                ...
                return client.resourceGroups.listResources(name, __cb(_, __frame, 16, 56, function ___(__0, __2) { resourceGroup.resources = __2;
  ...
  group.command("export [name] [directory]").description($("Captures a resource group as a template, and saves it as file on disk.")).usage("[options] <name> [directory]").option("-n --name <name>", $("the resource group name")).option("-d --directory [directory]", $("the name of the destination directory. If not specified, template file will be saved in the current directory.")).option("-c --includeComments", $("export template with comments.")).option("-p --includeParameterDefaultValue", $("export template parameter with default value")).option("-q --quiet", $("quiet mode (do not prompt for overwrite if output file exists)")).option("--subscription <subscription>", $("the subscription identifier")).execute(function __7(name, directory, options, _) { var subscription, client, confirm, result, template, error, fileName; var __frame = { name: "__7", line: 280 }; return __func(_, this, arguments, __7, 3, __frame, function __$__7() {
      ...
      client = utils.createResourceClient(subscription); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__7() {
          ...
          return cli.interaction.withProgress(util.format($("Exporting resource group as template %s"), name), function __1(log, _) { var exportOptions, parameters; var __frame = { name: "__1", line: 297 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  grouplog.command("show [name]").description($("Retrieves and shows logs for resource group operations")).option("-n --name <name>", $("the resource group name")).option("-a --all", $("returns logs for all operations (including CRUD and deployment)")).option("-l --last-deployment", $("returns logs for the last deployment")).option("-d --deployment <name>", $("the name of the deployment whose logs you want to see")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __8(name, options, _) { var subscription, progress, logStream, logEntry, isJson, logEntrySet;
    ...
    function endProgress() {
      if (progress) {
        progress.end();
        progress = null; } ; }; var __frame = { name: "__8", line: 432 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() { if (!name) { return _(null, cli.missingArgument("name")); } ; if (([options.all,options.lastDeployment,options.deployment,].filter(function(opt) { return opt; }).length > 1)) { return _(new Error($("Must specify only one of --all, --last-deployment, or --deployment switches"))); } ; subscription = profile.current.getSubscription(options.subscription); progress = cli.interaction.progress($("Getting group logs"));
