...
exports.init = function(cli) {
  ...
  vm.command("list [resourceGroup]").description($("Get all virtual machines in a resource group")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, options, _) { var vmClient; var __frame = { name: "__3", line: 182 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
  ...
  vm.command("show [resource-group] [name]").description($("Get a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-d, --depth <depth>", $("the number of times to recurse, to recurse indefinitely pass \"full\". (valid only with --json option)")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__5", line: 204 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
  ...
  vm.command("stop [resource-group] [name]").description($("Shutdown a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __7(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__7", line: 231 }; return __func(_, this, arguments, __7, 3, __frame, function __$__7() {
  ...
  vm.command("restart [resource-group] [name]").description($("Restart a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __8(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__8", line: 244 }; return __func(_, this, arguments, __8, 3, __frame, function __$__8() {
  ...
  vm.command("start [resource-group] [name]").description($("Start a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __9(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__9", line: 257 }; return __func(_, this, arguments, __9, 3, __frame, function __$__9() {
  ...
  vm.command("deallocate [resource-group] [name]").description($("Shutdown a virtual machine in a resource group and release the compute resources")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __10(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__10", line: 270 }; return __func(_, this, arguments, __10, 3, __frame, function __$__10() {
  ...
  vm.command("capture [resource-group] [name] [vhd-name-prefix]").description($("Capture a VM in a resource group as an OS Image or VM Image")).usage("[options] <resource-group> <name> <vhd-name-prefix>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-p, --vhd-name-prefix <vhd-name-prefix>", $("Captured virtual hard disk's name prefix")).option("-R, --storage-account-container-name <storage-account-container-name>", $("the storage account container name [vhds]")).option("-o, --overwrite", $("In case of conflict overwrite the target virtual hard disk if set to true.")).option("-t, --template-file-name <template-file-name>", $("Name of the file that will contain a template that can be used to create similar VMs.")).option("-s, --subscription <id>", $("the subscription id")).execute(function __12(resourceGroup, name, vhdNamePrefix, options, _) { var vmClient; var __frame = { name: "__12", line: 300 }; return __func(_, this, arguments, __12, 4, __frame, function __$__12() {
  ...
  vm.command("get-serial-output [resource-group] [name]").description($("Get serial output of a VM in a resource group.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).option("--max-length <max-length>", $("the max number of characters shown in one page of log output")).execute(function __15(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__15", line: 344 }; return __func(_, this, arguments, __15, 3, __frame, function __$__15() {
  ...
  vm.command("delete-backup [resource-group] [name]").description($("Deletes the backup for the vm")).usage("[options] <resource-group> <name>").option("-i, --identity <identity>", $("The identity of the backup")).execute(function __22(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__22", line: 471 }; return __func(_, this, arguments, __22, 3, __frame, function __$__22() {
  ...
  vm.command("show-disk-encryption-status [resource-group] [name]").description($("Show azure disk encryption status of a VM in a resource group.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __23(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__23", line: 484 }; return __func(_, this, arguments, __23, 3, __frame, function __$__23() {
  ...
  disk.command("list [resource-group] [vm-name]").description($("Get all data disks of a VM in a resource group")).usage("[options] <resource-group> <vm-name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --vm-name <vm-name>", $("the virtual machine name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __28(resourceGroup, vmName, vhdUrl, options, _) { var vmClient; var __frame = { name: "__28", line: 572 }; return __func(_, this, arguments, __28, 4, __frame, function __$__28() {
  ...
  extensionImage.command("list-publishers [location]").description($("Lists virtual machine/extension image publishers")).usage("[options] <location>").option("-l, --location <location>", $("the location")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __33(location, options, _) { var vmClient; var __frame = { name: "__33", line: 672 }; return __func(_, this, arguments, __33, 2, __frame, function __$__33() {
  ...
  extensionImage.command("list-types [location] [publisher]").description($("Lists virtual machine extension image types by a publisher")).usage("[options] <location> <publisher>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __34(location, publisher, options, _) { var vmClient; var __frame = { name: "__34", line: 685 }; return __func(_, this, arguments, __34, 3, __frame, function __$__34() {
  ...
  extensionImage.command("list [location] [publisher] [typeName]").description($("Lists virtual machine extension images by publisher, and type input")).usage("[options] <location> <publisher> <typeName>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-t, --typeName <typeName>", $("the type name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __36(location, publisher, typeName, options, _) { var vmClient; var __frame = { name: "__36", line: 716 }; return __func(_, this, arguments, __36, 4, __frame, function __$__36() {
  ...
  extensionImage.command("show [location] [publisher] [typeName] [version]").description($("Lists virtual machine extension image versions by publisher, type and version input")).usage("[options] <location> <publisher> <typeName> <version>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-t, --typeName <typeName>", $("the type name")).option("-v, --version <version>", $("the version")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __37(location, publisher, typeName, version, options, _) { var vmClient; var __frame = { name: "__37", line: 731 }; return __func(_, this, arguments, __37, 5, __frame, function __$__37() {
  ...
  image.command("list-publishers [location]").description($("Lists virtual machines image publishers")).usage("[options] <location>").option("-l, --location <location>", $("the location")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __39(location, options, _) { var vmClient; var __frame = { name: "__39", line: 835 }; return __func(_, this, arguments, __39, 2, __frame, function __$__39() {
  ...
  image.command("list-offers [location] [publisher]").description($("Lists virtual machines image offers by a publisher")).usage("[options] <location> <publisher>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __40(location, publisher, options, _) { var vmClient; var __frame = { name: "__40", line: 848 }; return __func(_, this, arguments, __40, 3, __frame, function __$__40() {
  ...
  image.command("list [location] [publisher] [offer] [sku]").description($("Lists the virtual machines images")).usage("[options] <location> <publisher> [offer] [sku]").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-o, --offer <offer>", $("the offer")).option("-k, --sku <sku>", $("the sku")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __42(location, publisher, offer, sku, options, _) { var vmClient, params; var __frame = { name: "__42", line: 880 }; return __func(_, this, arguments, __42, 5, __frame, function __$__42() {
  ...
  image.command("show [location] [publisher] [offer] [sku] [version]").description($("Lists the virtual machines images")).usage("[options] <location> <publisher> [offer] [sku]").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-o, --offer <offer>", $("the offer")).option("-k, --sku <sku>", $("the sku")).option("-e, --version <version>", $("the version")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __43(location, publisher, offer, sku, version, options, _) { var vmClient, params; var __frame = { name: "__43", line: 904 }; return __func(_, this, arguments, __43, 6, __frame, function __$__43() {
