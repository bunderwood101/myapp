...
exports.init = function(cli) {
  var log = cli.output;
  var insightsDiagnosticCommand = cli.category("insights").category("diagnostic").description($("Configure diagnostics for resources")).command("set").description($("Set the diagnostics for the resource.")).usage("[options]").option("-i, --resourceId <resourceId>", $("resource Id.")).option("-a, --storageId <storageId>", $("storage account Id.")).option("-e, --enabled <enabled>", $("whether the configuration is enabled or disabled.")).option("-c, --categories <categories>", $("comma separated list of categories to be affected. Valid values vary per resource type.")).option("-t, --timegrains <timegrains>", $("comma separated list of timegrains to be affected in ISO 8601 format. Example: 'PT1M' for 1 minute.")).execute(function __1(options, _) { var __frame = { name: "__1", line: 37 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  insightsDiagnosticCommand._prepareAndExecute = function insightsDiagnosticCommand__prepareAndExecute__2(options, _) { var client, __this = this; var __frame = { name: "insightsDiagnosticCommand__prepareAndExecute__2", line: 41 }; return __func(_, this, arguments, insightsDiagnosticCommand__prepareAndExecute__2, 1, __frame, function __$insightsDiagnosticCommand__prepareAndExecute__2() {
  ...
  insightsDiagnosticCommand._executeCmd = function insightsDiagnosticCommand__executeCmd__3(client, options, _) { var putParameters, getResponse, properties, i, j, logSettings, metricSettings, __this = this; var __frame = { name: "insightsDiagnosticCommand__executeCmd__3", line: 59 }; return __func(_, this, arguments, insightsDiagnosticCommand__executeCmd__3, 2, __frame, function __$insightsDiagnosticCommand__executeCmd__3() {
      putParameters = { };
      return client.serviceDiagnosticSettingsOperations.get(options.resourceId, __cb(_, __frame, 2, 65, function ___(__0, __1) { getResponse = __1;
        ...
        return client.serviceDiagnosticSettingsOperations.put(options.resourceId, putParameters, __cb(_, __frame, 68, 47, function __$insightsDiagnosticCommand__executeCmd__3() {
